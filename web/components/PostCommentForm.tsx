"use client";
// Formulario de comentario de un POST. Clon de CommentForm a nivel post.
import { useRef, useState, useTransition } from "react";
import { addPostComment } from "@/app/post/[id]/actions";
...
export function PostCommentForm({ postId }: { postId: string }) {
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    startTransition(async () => {
      ...
      fd.set("texto", value);
      const res = await addPostComment(postId, fd);
